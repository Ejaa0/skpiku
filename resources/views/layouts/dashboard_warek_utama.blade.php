...
<body class="flex flex-col md:flex-row min-h-screen bg-gray-100 dark:bg-gray-900 text-gray-800 dark:text-gray-200">
    ...
    <aside class="w-full md:w-64 bg-white dark:bg-gray-800 shadow-md p-6 space-y-4 animate-slideIn z-10">
        ...
        <nav class="space-y-2 text-gray-700 dark:text-gray-200 font-medium">
            ...
            <a href="{{ route('organisasi.index') }}" class="flex items-center py-2 px-4 rounded-lg hover:bg-blue-100 dark:hover:bg-gray-700 transition">
                🏢 <span class="ml-2">Data Organisasi</span>
            </a>
            <a href="{{ url('/mahasiswa/data') }}" class="flex items-center py-2 px-4 rounded-lg hover:bg-blue-100 dark:hover:bg-gray-700 transition">
            ...
            <a href="{{ route('poin.index') }}" class="flex items-center py-2 px-4 rounded-lg hover:bg-blue-100 dark:hover:bg-gray-700 transition">
