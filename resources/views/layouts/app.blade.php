    ...
    <aside :class="open ? 'translate-x-0' : '-translate-x-full'"
        ...
        <div class="flex flex-col h-full p-6 space-y-6">
            ...
            <div class="text-center">
                <div class="w-24 h-24 rounded-full bg-gray-400 flex items-center justify-center mx-auto mb-2 text-white text-3xl font-bold">
                    {{ strtoupper(substr(session('admin_name') ?? 'A', 0, 1)) }}
                </div>
                <p class="text-center font-semibold text-white text-lg">{{ session('admin_name') ?? 'Admin' }}</p>
        ...
        <footer class="bg-primary text-white mt-12">
            <div class="max-w-7xl mx-auto px-6 py-12 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
                ...
                <div>
                    ...
                    <p class="text-sm text-blue-100 mt-2">Email: <a href="mailto:info@unai.edu" class="underline hover:text-white">info@unai.edu</a></p>
