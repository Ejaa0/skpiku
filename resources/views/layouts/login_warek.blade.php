...
<div class="max-w-md mx-auto mt-20 bg-white dark:bg-gray-800 p-10 rounded-3xl shadow-2xl">
    <div class="text-center mb-8">
        <div 
            class="inline-block text-7xl select-none smooth-bounce" 
            aria-hidden="true"
        >👨‍💼</div>
    ...
    <div class="text-center mt-8">
        <a href="{{ url('/') }}" class="text-sm font-medium text-blue-600 hover:underline">← Kembali ke Halaman Utama</a>
    </div>
</div>
@endsection
