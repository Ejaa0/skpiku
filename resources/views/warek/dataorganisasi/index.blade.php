...
<div class="container mx-auto p-4">
    ...
    {{-- Form Pencarian --}}
    <form method="GET" action="{{ route('warek.dataorganisasi.index') }}" class="mb-4 flex items-center space-x-2">
    ...
    @if(request('q'))
        <p class="mb-2 text-gray-500 dark:text-gray-400">Hasil pencarian untuk: <strong>{{ request('q') }}</strong></p>
    @endif
            ...
            <tbody>
                ...
                <tr class="border-b dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700 transition">
                    ...
                    <td class="px-4 py-2 space-x-2">
                        ...
                        <a href="{{ route('organisasi.edit', $org->id_organisasi) }}" 
                           class="px-2 py-1 bg-yellow-500 text-white rounded hover:bg-yellow-600">Edit</a>
                        <form action="{{ route('organisasi.destroy', $org->id_organisasi) }}" method="POST" class="inline-block" 
                ...
                @empty
                <tr>
                    <td colspan="4" class="px-4 py-2 text-center text-gray-500 dark:text-gray-400">Tidak ada data organisasi.</td>
                </tr>
                @endforelse
            </tbody>
        </table>
